...
/*
 * De bron mag als .gz, als .zip of plat aangeleverd worden. Gezipt is nodig omdat de
 * webupload van GitHub bij 25 MB stopt en het rauwe bestand daar net boven zit.
 *
 * Staan er meerdere varianten naast elkaar, dan stoppen we: dan is niet te zien welke
